...
lakehouses_to_run = [
    {'name': 'lh_bronze', 'orchestrator': '00_orchestrator_lh_bronze_lakehouse_ddl_scripts'},
    {'name': 'lh_gold', 'orchestrator': '00_orchestrator_lh_gold_lakehouse_ddl_scripts'},
    {'name': 'lh_silver', 'orchestrator': '00_orchestrator_lh_silver_lakehouse_ddl_scripts'},
]
...
if failed_count == 0 and exception_count == 0:
    ...
    error_summary = f"failed: {failed_count + exception_count} of 3 lakehouses failed"
