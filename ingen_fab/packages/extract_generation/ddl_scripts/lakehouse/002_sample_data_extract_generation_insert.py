...
sample_extract_details = [
    ...
    Row(
        ...
        fabric_lakehouse_path="tmp/spark/Files/synthetic_data/incremental/retail_oltp_small/files/incremental/orders",
        force_single_file=True,
        created_date="2024-01-15",
        created_by="system",
        modified_date=None,
    ...
    Row(
        ...
        compressed_file_name=None,
        compressed_extension=".parquet",
        fabric_lakehouse_path="tmp/spark/Files/synthetic_data/incremental/retail_oltp_small/files/incremental/order_items",
        force_single_file=True,
        created_date="2024-01-15",
        created_by="system",
        modified_date=None,
