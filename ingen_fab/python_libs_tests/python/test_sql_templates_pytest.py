...
class TestRequiredFilter:
    ...
    def test_required_filter_with_none(self):
        ...
        with pytest.raises(exceptions.TemplateRuntimeError, match="Required parameter 'test_var' was not provided"):
    ...
    def test_required_filter_without_var_name(self):
        ...
        with pytest.raises(exceptions.TemplateRuntimeError, match="Required parameter 'unknown' was not provided"):
...
class TestSQLTemplates:
    ...
    def test_get_template_wrong_dialect(self):
        ...
        sql_templates = SQLTemplates("fabric")
        with pytest.raises(FileNotFoundError, match="Template check_schema_exists for dialect nonexistent not found"):
    ...
    def test_render_check_table_exists(self):
        ...
        sql_templates = SQLTemplates("fabric")
        result = sql_templates.render("check_table_exists", 
    ...
    def test_render_create_table(self):
        ...
        result = sql_templates.render("create_table", 
                                     schema_name="test_schema", 
                                     table_name="test_table",
                                     schema=schema)
    ...
    def test_render_drop_table(self):
        ...
        sql_templates = SQLTemplates("fabric")
        result = sql_templates.render("drop_table", 
                                     schema_name="test_schema", 
                                     table_name="test_table")
    ...
    def test_render_read_table_basic(self):
        ...
        sql_templates = SQLTemplates("fabric")
        result = sql_templates.render("read_table", 
                                     schema_name="test_schema", 
                                     table_name="test_table")
    ...
    def test_render_delete_from_table(self):
        ...
        sql_templates = SQLTemplates("fabric")
        result = sql_templates.render("delete_from_table", 
                                     schema_name="test_schema", 
                                     table_name="test_table",
                                     filters={"id": "123"})
    ...
    def test_render_insert_row(self):
        ...
        sql_templates = SQLTemplates("fabric")
        result = sql_templates.render("insert_row", 
                                     schema_name="test_schema", 
                                     table_name="test_table",
    ...
    def test_render_get_table_schema(self):
        ...
        sql_templates = SQLTemplates("fabric")
        result = sql_templates.render("get_table_schema", 
                                     schema_name="test_schema", 
                                     table_name="test_table")
    ...
    def test_render_get_table_row_count(self):
        ...
        sql_templates = SQLTemplates("fabric")
        result = sql_templates.render("get_table_row_count", 
                                     schema_name="test_schema", 
                                     table_name="test_table")
    ...
    def test_render_get_table_metadata(self):
        ...
        sql_templates = SQLTemplates("fabric")
        result = sql_templates.render("get_table_metadata", 
                                     schema_name="test_schema", 
                                     table_name="test_table")
        assert "SELECT *" in result
        assert "INFORMATION_SCHEMA.TABLES" in result
    ...
    def test_render_rename_table_fabric(self):
        ...
        sql_templates = SQLTemplates("fabric")
        result = sql_templates.render("rename_table", 
                                     schema_name="test_schema", 
    ...
    def test_render_vacuum_table(self):
        ...
        sql_templates = SQLTemplates("fabric")
        result = sql_templates.render("vacuum_table", 
                                     schema_name="test_schema", 
                                     table_name="test_table")
    ...
    def test_render_create_table_from_values(self):
        ...
        sql_templates = SQLTemplates("fabric")
        result = sql_templates.render("create_table_from_values", 
                                     schema_name="test_schema", 
                                     table_name="test_table",
