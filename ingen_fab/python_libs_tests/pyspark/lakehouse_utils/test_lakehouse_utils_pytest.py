...
def customers_data():
    return [
        ...
        (2, "Jane Smith", "jane.smith@example.com", datetime.datetime(2023, 2, 20, 14, 30)),
        (3, "Alice Brown", "alice.brown@example.com", datetime.datetime(2023, 3, 25, 9, 15)),
    ]
...
def test_multiple_table_management(utils, customers_schema, customers_data, orders_schema, orders_data, products_schema, products_data):
