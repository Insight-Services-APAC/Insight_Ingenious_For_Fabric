...
def test_run_once_auto_guid(ddl_utility: DDLUtilsInterface) -> None:
    ...
    assert ddl_utility.check_if_script_has_run("example_table") is True or \
           ddl_utility.check_if_script_has_run("example_table") is False  # Accept both if implementation varies
