...
class ConfigurableSyntheticDataGenerator:
    ...
    def generate_dataset_with_runtime_scaling(self,
                                            base_config_id: str,
                                            generation_date: Union[str, date],
                                            scale_factor: float = 1.0,
                                            seasonal_adjustments: Dict[str, float] = None,
                                            table_multipliers: Dict[str, float] = None) -> Dict[str, Any]:
        """
    ...
    def generate_custom_dataset(self,
                              ...
                              generation_date: Union[str, date] = None,
                              output_settings: Dict[str, Any] = None) -> Dict[str, Any]:
        """
    ...
    def preview_generation_plan(self,
                              dataset_config_id: str = None,
                              dataset_config: Union[DatasetConfiguration, Dict[str, Any]] = None,
                              generation_date: Union[str, date] = None,
                              runtime_overrides: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        if dataset_config_id:
            ...
            config = DatasetConfiguration.from_dict(dataset_config) if isinstance(dataset_config, dict) else dataset_config
        else:
    ...
    def create_config_from_template(self,
                                  template_id: str,
                                  new_dataset_id: str,
                                  customizations: Dict[str, Any] = None) -> DatasetConfiguration:
        """
...
class ConfigurableDatasetBuilder:
    ...
    def build_retail_oltp_dataset(self,
                                scale: Literal["small", "medium", "large"] = "medium",
                                generation_date: Union[str, date] = None,
                                seasonal_adjustments: Dict[str, float] = None) -> Dict[str, Any]:
        """Build a retail OLTP dataset with configurable scale."""
        
        scale_configs = {
            "small": {"global_scale": 0.1, "customers": 1000, "products": 100, "orders_per_day": 1000},
            "medium": {"global_scale": 1.0, "customers": 10000, "products": 1000, "orders_per_day": 10000},
            "large": {"global_scale": 10.0, "customers": 100000, "products": 10000, "orders_per_day": 100000}
        }
    ...
    def build_analytics_dataset(self,
                              fact_rows: int = 1000000,
                              customer_count: int = 100000,
                              product_count: int = 10000,
                              generation_date: Union[str, date] = None) -> Dict[str, Any]:
    ...
    def build_time_series_dataset(self,
                                start_date: Union[str, date],
                                end_date: Union[str, date],
