...
Using Fabric environment: local
 ...
 Usage: python -m ingen_fab.cli ddl [OPTIONS] COMMAND [ARGS]...

 Commands for compiling DDL notebooks.
...
╰──────────────────────────────────────────────────────────────────────────────╯
╭─ Commands ───────────────────────────────────────────────────────────────────╮
│ compile              Compile the DDL notebooks in the specified project      │
│                      directory.                                              │
│ ddls-from-metadata   Create DDL scripts from metadata.                       │
╰──────────────────────────────────────────────────────────────────────────────╯
```
