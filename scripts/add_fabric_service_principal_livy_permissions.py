...
add_permission_cmd = [
    ...
    "--id", app_id,
    "--api", storage_api_id,
    "--api-permissions", "03e0da56-190b-40ad-a80c-ea378c433f7f=Scope"  # user_impersonation
]
...
add_powerbi_permission_cmd = [
    ...
    "--id", app_id,
    "--api", powerbi_api_id,
    "--api-permissions", "a65a6bd9-0978-46d6-a261-36b3e6fdd32e=Scope"  # Workspace.Read.All
]
...
try:
    ...
    print("WARNING: Could not grant admin consent automatically. You may need to grant consent manually in the Azure Portal.")
    print(f"Portal URL: https://portal.azure.com/#blade/Microsoft_AAD_RegisteredApps/ApplicationMenuBlade/CallAnAPI/appId/{app_id}")
