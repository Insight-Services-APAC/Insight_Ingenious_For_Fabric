CREATE TABLE [config].[parquet_loak] (
...
ALTER TABLE [config].[parquet_loak] ADD CONSTRAINT PK_parquet_loak primary key NONCLUSTERED ([target_lakehouse_workspace_id], [target_lakehouse_name]);