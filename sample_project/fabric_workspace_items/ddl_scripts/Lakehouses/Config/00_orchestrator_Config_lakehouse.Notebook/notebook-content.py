...
def execute_notebook(notebook_name, index, total, timeout_seconds=3600):
    ...
    try:
        ...
        result = notebookutils.mssparkutils.notebook.run(
            notebook_name, timeout_seconds, params
        )
...
print("Starting orchestration for Config lakehouse")
print(f"Start time: {start_time}")
print("Total notebooks to execute: 4")
print("=" * 60)
execute_notebook(
    "001_Initial_Creation_SyntheticData_Config_Lakehouses_ddl_scripts", 1, 4
)
