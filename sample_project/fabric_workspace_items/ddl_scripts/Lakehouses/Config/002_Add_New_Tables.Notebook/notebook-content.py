...
class config_utils:
    ...
    class FabricConfig:
        ...
        edw_warehouse_workspace_Id: str
        edw_warehouse_id: str
        edw_warehouse_name: str
        edw_lakehouse_workspace_Id: str
    ...
    def config_schema() -> StructType:
        return StructType([
            ...
            StructField("edw_warehouse_workspace_Id", StringType(), nullable=False),
            StructField("edw_warehouse_id", StringType(), nullable=False),
            StructField("edw_warehouse_name", StringType(), nullable=False),
            StructField("edw_lakehouse_workspace_Id", StringType(), nullable=False),
...
# ## 𝄜 Cell for 007_table2_schema_create.sql

# CELL ********************

# MAGIC %%sql 
# MAGIC 
# MAGIC CREATE TABLE IF NOT EXISTS sales_data (
...
# MAGIC COMMENT 'Sample sales data table for analytics'
# MAGIC TBLPROPERTIES (
...
# ## 📇 If we make it to the end return a successful result
