...
(
    ...
    'Files/synthetic_data/retail_oltp_small/customers.parquet',
    'parquet',
...
(
    ...
    'Files/synthetic_data/retail_oltp_small/products.parquet',
    'parquet',
    '{{varlib:config_workspace_id}}',
    '{{varlib:config_lakehouse_id}}',
    'lakehouse',
...
(
    ...
    'Files/synthetic_data/retail_oltp_small/orders.parquet',
    'parquet',
    '{{varlib:config_workspace_id}}',
    '{{varlib:config_lakehouse_id}}',
    'lakehouse',
...
(
    ...
    'Files/synthetic_data/retail_oltp_small/order_items.parquet',
    'parquet',
    '{{varlib:config_workspace_id}}',
    '{{varlib:config_lakehouse_id}}',
    'lakehouse',
...
(
    ...
    'Files/synthetic_data/retail_oltp_incremental',
    'csv',
    '{{varlib:config_workspace_id}}',
    '{{varlib:config_wh_warehouse_id}}',
    'warehouse',
...
(
    'retail_stores_incremental_wh',
    'Retail Stores Incremental Import (Warehouse)',
    'Files/synthetic_data/retail_oltp_incremental',
    'csv',
    '{{varlib:config_workspace_id}}',
    '{{varlib:config_wh_warehouse_id}}',
    ...
    'merge',
    'store_id',
    '{"required_columns": ["store_id", "store_name", "city"]}',
    'log',
    10,
    'Y',
    GETDATE(),
...
(
    'retail_inventory_incremental_wh',
    'Retail Inventory Incremental Import (Warehouse)', 
    'Files/synthetic_data/retail_oltp_incremental',
    'csv',
    '{{varlib:config_workspace_id}}',
    '{{varlib:config_wh_warehouse_id}}',
    ...
    '{"required_columns": ["store_id", "product_id", "quantity_on_hand"]}',
    'log',
    12,
    'Y',
    GETDATE(),
...
PRINT '✓ Inserted 15 sample configuration records (9 original + 6 incremental synthetic data)';
