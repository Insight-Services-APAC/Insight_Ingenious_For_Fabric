...
print("="*60)
execute_notebook("001_Initial_Creation_Config_Warehouses", 1, 3)
execute_notebook("001_Initial_Creation_Ingestion_Config_Warehouses", 2, 3)
execute_notebook("002_Parquet_Load_Update_Config_Warehouses", 3, 3)
