...
print("="*60)
execute_notebook("001_Initial_Creation_Config_WH_Warehouses_ddl_scripts", 1, 2)
execute_notebook("001_Initial_Creation_ExtractGeneration_Config_WH_Warehouses_ddl_scripts", 2, 2)
