...
# ## 𝄜 Cell for 009_sample_data_insert_aligned.sql
...
du.run_once(work,"009_sample_data_insert_aligned", guid)
...
# ## 𝄜 Cell for 010_synthetic_data_alignment_views.sql
...
du.run_once(work,"010_synthetic_data_alignment_views", guid)
